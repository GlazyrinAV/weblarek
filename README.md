...
Формирует событие `order:validationSuccess` или `order:validationFail` в зависимости от результата проверки;
...
- `order:validationSuccess` - активирует кнопку при удачной проверке Модели заказа;
- `order:validationFail` - деактивирует кнопку при неудачной проверке Модели заказа;
